...
describe("WebSocket Gemini Live — audio responses", () => {
  ...
  it("defaults to audio/mp3 when object-form AudioResponse omits contentType", async () => {
    const audioFixture: Fixture = {
    ...
    expect(msg.serverContent.modelTurn.parts[0].inlineData.mimeType).toBe("audio/mp3");
